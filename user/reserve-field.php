  ...
  <div data-page="team" class="page">
    ...
    <div id="pages_maincontent">
        ...
        <?php
              ...
              $sql = "SELECT * FROM facilities WHERE location_id='$loc_id' ORDER BY id ASC";
	 ...
	 <h2 class="page_title">SELECT YOUR FIELD</h2>	  
   <div class="page_single layout_fullwidth_padding">  
		  <div class="swiper-container-teambigger">
            ...
            // Fetch all users data from database
            $sql = "SELECT * FROM field WHERE location_id='$loc_id' ORDER BY id ASC";
            $result = mysqli_query($mysqli, $sql) or die (mysqli_error($mysqli));
                ...
                while($fl = mysqli_fetch_array($result)) {  
                    ...
                    // echo "</div>";
                    echo "<div class='swiper-slide team-block'>";
                    echo "<a href='reserve-member.php?field=".$fl['id']."&loc=".$loc_id."' data-view='.view-main'><img src='images/".$fl['picture']."' alt='' title='' /></a>";
                    echo "<strong>".$fl['field_name']."</strong>";
                    echo "<a href='reserve-member.php?field=".$fl['id']."&loc=".$loc_id."' data-view='.view-main'><span>RESERV NOW</span></a>";
                    echo "</div>";
                }
      ...
      <a href='reserve.php'class='btn btn--full' style='margin-top:15px;'>Back</a>
