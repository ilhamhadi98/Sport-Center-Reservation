    ...
    <div class="page-content">
     ...
     <div class="page_single layout_fullwidth_padding">
                ...
                <ul class="responsive_table">
                    ...
                    $sql = "SELECT * FROM price WHERE field_id='$fld_id' AND location_id='$loc_id' ORDER BY id ASC";
                ...
                <h3 style="padding-top:1cm;">Select your member category</h3>
                <ul class="responsive_table">
                    <?php
                    // Create database connection using config file
                    include_once("koneksi.php");
                    ...
                    // Fetch all users data from database
                    $result = mysqli_query($mysqli, "SELECT * FROM price WHERE field_id='$fld_id' AND location_id='$loc_id' ORDER BY id ASC");
                        
                        while($price = mysqli_fetch_array($result)) {   
                            echo "<a href='booking-schedule.php?field=".$fld_id."&loc=".$loc_id."&prc=".$price['id']."' class='btn btn--full'>".$price['category']."</a> ";
                            // echo "<a href='booking-form-".$price['url'].".php?field=".$fld_id."&loc=".$loc_id."&prc=".$price['id']."' class='btn btn--full'>".$price['category']."</a> ";
                        }
