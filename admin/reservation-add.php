        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add New Manual Recervation</h1>
            ...
            <?php
                ...
                if(isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($mysqli, "INSERT INTO reservation (location_id, field_id, price_id, name, email, mobile, start_date,
                    start_time, end_time, status, username, picture) VALUES ('$location_id', '$field_id', '$price_id', '$name', '$email'
                    , '$mobile', '$start_date', '$start_time', '$end_time', '$status', '$username', '$picture')");
                    
                    // Show message when user added
                    echo "<br>";
                    echo "<div class='alert alert-success col-lg-6' role='alert' style='margin-left:10px;'>";
                    echo "<b>Selemat!</b> data berhasil ditambah. <a href='reservation.php' class='alert-link'>klik disini</a> untuk kembali.";
                    echo "</div>";
