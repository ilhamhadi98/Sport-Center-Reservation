...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE blog SET title='$title', intro='$intro', detail='$detail', picture='$picture', url='$url' WHERE id=$id");
                ...
                <div class="card-body">
                  <form action="blog-edit.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="detail" value=<?php echo $detail;?>
                        id="exampleFormControlTextarea1" rows="3"><?php echo $detail;?></textarea>
                    </div>
                    <div class="form-group">
