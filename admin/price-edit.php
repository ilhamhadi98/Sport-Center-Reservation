...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE price SET location_id='$location_id', field_id='$field_id', category='$category', price='$price', type='$type', url='$url' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM price WHERE id=$id");
