        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add New Price</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="price-add.php" method="post">
            ...
            <?php
                ...
                if(isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($mysqli, "INSERT INTO price (location_id, field_id, category, price, type, url) 
                    VALUES ('$location_id', '$field_id', '$category', '$price', '$type', '$url')");
                    
                    // Show message when user added
                    echo "<br>";
                    echo "<div class='alert alert-success col-lg-6' role='alert' style='margin-left:10px;'>";
                    echo "<b>Selemat!</b> data berhasil ditambah. <a href='price.php' class='alert-link'>klik disini</a> untuk kembali.";
                    echo "</div>";
