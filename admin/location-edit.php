...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE location SET location_name='$location_name', address='$address', picture='$picture' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM location WHERE id=$id");
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="location-edit.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="address"
                                                id="exampleFormControlTextarea1" rows="3"><?php echo $address;?></textarea>
                                        </div>
                                        <div class="form-group">
