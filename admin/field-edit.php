...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE field SET location_id='$location_id', field_name='$field_name', picture='$picture', url='$url' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM field WHERE id=$id");

while($blog = mysqli_fetch_array($result))
{
    $location_id = $blog['location_id'];
    $field_name = $blog['field_name'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="field-edit.php" method="post">
