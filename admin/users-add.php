    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Proses Add -->
                ...
                if(isset($_POST['Submit'])) {
                    ...
                    echo "<b>Selemat!</b> data berhasil ditambah. <a href='users.php' class='alert-link'>klik disini</a> untuk kembali.";
                    echo "</div>";
                    // echo "<h4><center><strong>Selamat!</strong> data user berhasil ditambahkan.</center></h4>";
                    // echo "<a href='users.php' class='btn btn--full'>KEMBALI</a>";
