...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE facilities SET location_id='$location_id', facilities_name='$facilities_name', picture='$picture', css='$css', des='$des' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM facilities WHERE id=$id");

while($blog = mysqli_fetch_array($result))
{
    $location_id = $blog['location_id'];
    $facilities_name = $blog['facilities_name'];
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">SfR <sup><span
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="facilities-edit.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="location_id">
                                                ...
                                                ?>
                                                                        <option value="<?=$data['id']?>">Pipa <?=$data['location_name']?>
                                                                        </option>
                                                                        <?php
                                                }
                                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="facilities_name" value="<?php echo $facilities_name;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">CSS Code</label>
                                            <input type="text" class="form-control" name="css" value="<?php echo $css;?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="picture" value="avatar.jpg">
                                        </div>
                                        <div class="form-group">
