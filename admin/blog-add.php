    ...
    <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form action="blog-add.php" method="post">
      ...
      <?php
                ...
                if(isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($mysqli, "INSERT INTO blog (title, intro, detail, picture, url) VALUES('$title', '$intro', '$detail', '$picture', '$url')");
                    
                    // Show message when user added
                    echo "<br>";
                    echo "<div class='alert alert-success col-lg-6' role='alert' style='margin-left:10px;'>";
                    echo "<b>Selemat!</b> data berhasil ditambah. <a href='blog.php' class='alert-link'>klik disini</a> untuk kembali.";
                    echo "</div>";
